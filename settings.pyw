...
class Window(Tk):
    def __init__(self):
        ...
        self.dateFirst = Radiobutton(self.dateFrame, text="Sélection premier jour disponible", variable=self.date, value=0)
        self.dateLast = Radiobutton(self.dateFrame, text="Sélection dernier jour disponible", variable=self.date, value=-1)
        ...
        self.periodFrame = LabelFrame(text='Décidez comment choisir le période de paiement')
        self.period = IntVar()
        self.period.set(self.config['period'])
        self.periodFirst = Radiobutton(self.periodFrame, text="Sélection première période disponible", variable=self.period, value=0)
        self.periodLast = Radiobutton(self.periodFrame, text="Sélection dernier période disponible", variable=self.period, value=-1)
